// Reference https://qiita.com/MoriokaReimen/items/5c4256ef620499a88bb3
...
int main () {
  ...
  const auto segment_id = shmget(key, shared_segment_size, IPC_CREAT | IPC_EXCL | S_IRUSR | S_IWUSR);
